import BinaryHeapStrategy from "ts-priority-queue/src/BinaryHeapStrategy.js";
import PriorityQueue from "ts-priority-queue/src/PriorityQueue.js";
import { Coordinates } from "./helper.js";
...
export class Dijkstra {
  ...
  public getEndPointCostFromStart(endCoordinates: Coordinates) {
    let unvisited: PriorityQueue<QueueData> = new PriorityQueue<QueueData>({
